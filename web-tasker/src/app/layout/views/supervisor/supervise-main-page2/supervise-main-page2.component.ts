...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, TeamFilterPipe],
  templateUrl: './supervise-main-page2.component.html',
  styleUrls: ['./supervise-main-page2.component.scss'],
})
export class SuperviseMainPage2Component implements OnInit {
  teams: any = [];
  projects: any = [];
  supervisorId!: string;
  supTeamCount = 0;
