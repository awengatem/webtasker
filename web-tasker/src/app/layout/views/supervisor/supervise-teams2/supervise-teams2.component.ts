...
@Component({
  ...
  templateUrl: './supervise-teams2.component.html',
  styleUrl: './supervise-teams2.component.scss',
})
export class SuperviseTeams2Component implements OnInit {
  teams!: any[];
  teamsLength = 0;
  teamDiv: any;
  teamStatus: any;
